...
- The `SC_expression.csv` file contains gene expression of yeast strains in the experiment.
- The `labels.csv` files pertain to gene validation status and molecular function (MF), cellular component (CC), and biological processes (BP). 
