...
```{r}
conditions_df <- read_csv("../../data/conditions_annotation.csv") %>% 
  rename(condition = ID) %>% 
...
```{r}
expressions_df <- read_csv("../../data/SC_expression.csv")
```
...
```{r}
write_csv(tidy_expressions, "../../app/tidy_data/tidy_expressions.csv")
write_csv(tidy_conditions, "../../app/tidy_data/tidy_conditions.csv")
write_csv(tidy_attributes, "../../app/tidy_data/tidy_attributes.csv")
```
